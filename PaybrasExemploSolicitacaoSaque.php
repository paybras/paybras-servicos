...
<body>
<form method="post" target="_self" action="lib.paybras/servicos/PaybrasSolicitacaoSaque.php" style="width: 300px">
    ...
    <label>ID da Conta Bancária*</label><input type="text" name="id_conta_bancaria" value="134" />
    <label>Valor Saque*</label><input type="text" name="valor_saque" value="3225.25" />
